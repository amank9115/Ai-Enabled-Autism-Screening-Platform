  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} className="rounded-3xl border border-slate-200/70 bg-white/80 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl dark:border-slate-700 dark:bg-slate-900/60">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-300">Complete this profile before starting AI screening. Data stays in app state and can be sent to backend later.</p>
        ...
        <form onSubmit={submit} className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2 flex justify-end gap-2">
            ...
            <button type="submit" className="rounded-xl bg-gradient-to-r from-sky-500 to-emerald-500 px-4 py-2 text-sm font-semibold text-white">Save and Start Screening</button>
          </div>
        </form>
      </motion.div>
    </section>
